...
def main():
    ...
    toolchains = os.listdir("toolchains/make_package")
    ...
    build_parser.add_argument("--no-build", action="store_false",
            dest="build", help="Set up containers, but don't run ninja.")

    # ./tuscan.py postprocess
    postprocess_parser = subparsers.add_parser("post",
            help="Post-process results generated by tuscan build.")

    toolchains = os.listdir("output/results")
