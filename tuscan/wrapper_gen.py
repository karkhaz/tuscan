...
def main():
    ...
    required_files = [
        os.path.join(make_package_dir, "binutil_transforms.yaml"),
        os.path.join(make_package_dir, "Dockerfile"),
        os.path.join("tuscan", "compiler_wrapper.c"),
    ]
    ...
    with open(os.path.join(make_package_dir, "binutil_transforms.yaml")) as f:
    ...
    wrapper_temp = jinja.get_template("compiler_wrapper.c")
