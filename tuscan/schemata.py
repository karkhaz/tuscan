...
post_processed_schema = voluptuous.Schema({
    ...
    voluptuous.Required("errors"): list,
    # Does a configure log file exist? Does it show the status of the
    # configure invocation? Was the configure script generated by
    # autoconf?
    voluptuous.Required("configure_log_exists"): bool,
    voluptuous.Required("configure_log_success"): voluptuous.Any(bool, None),
    voluptuous.Required("configure_log_autoconf"): voluptuous.Any(bool, None),
    # Was a configure process invoked, as detected by Red? Was it
    # successful?
    voluptuous.Required("configure_process_exists"): bool,
    voluptuous.Required("configure_process_success"): voluptuous.Any(bool, None),
