...
def main():
    ...
    # ABS packages cannot be built as root. We need this user both for
    # building bear at this stage, and for doing each of the builds in
    # the make_package stage.
    ...
    with TemporaryDirectory() as d:
        ...
        with tar_open(bear_tar, "w:xz") as tar:
